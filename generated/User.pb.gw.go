...
/*
Package com_awesome_model is a reverse proxy.
...
func request_User_GetName_0(ctx context.Context, marshaler runtime.Marshaler, client UserClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Req
...
func RegisterUserHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserClient) error {
	...
	mux.Handle("POST", pattern_User_GetName_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_User_GetName_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_User_GetName_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_User_GetName_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "model", "name"}, ""))
)

var (
	forward_User_GetName_0 = runtime.ForwardResponseMessage
)
